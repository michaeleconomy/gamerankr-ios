...
//                    }
//                }
//                completionHandler(Result<GraphQLResponse, Error>.failure(error!))
//                return
//            }
//            
...
//                completionHandler(Result<GraphQLResponse, Error>.failure(GameRankrAuthenticationError()))
//                return
//            }
//            
//            if (httpResponse.statusCode != 200) {
//                completionHandler(Result<GraphQLResponse, Error>.failure( GraphQLHTTPResponseError(body: data, response: httpResponse, kind: .errorResponse)))
//                return
//            }
//            
//            guard let data = data else {
//                completionHandler(Result<GraphQLResponse, Error>.failure(GraphQLHTTPResponseError(body: nil, response: httpResponse, kind: .invalidResponse)))
//                return
//            }
//            
//            do {
...
//                completionHandler(Result<GraphQLResponse, Error>.success(response))
//            } catch {
//                completionHandler(Result<GraphQLResponse, Error>.failure(error))
//            }
//        }
