...
extension Api {
  class MyGamesQuery: GraphQLQuery {
    static let operationName: String = "MyGames"
    static let operationDocument: ApolloAPI.OperationDocument = .init(
      definition: .init(
        #"query MyGames($after: String) { my_games(first: 30, after: $after) { __typename edges { __typename ranking: node { __typename ...RankingWithGame } } pageInfo { __typename endCursor hasNextPage } } }"#,
    ...
    struct Data: Api.SelectionSet {
      ...
      static var __selections: [ApolloAPI.Selection] { [
        .field("my_games", My_games.self, arguments: [
          "first": 30,
      ...
      var my_games: My_games { __data["my_games"] }

      /// My_games
      ///
      /// Parent Type: `RankingConnection`
      struct My_games: Api.SelectionSet {
        let __data: DataDict
        init(_dataDict: DataDict) { __data = _dataDict }
