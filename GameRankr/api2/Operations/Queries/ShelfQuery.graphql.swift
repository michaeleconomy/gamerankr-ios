...
extension Api {
  class ShelfQuery: GraphQLQuery {
    static let operationName: String = "Shelf"
    static let operationDocument: ApolloAPI.OperationDocument = .init(
      definition: .init(
        #"query Shelf($id: ID!, $after: String) { shelf(id: $id) { __typename rankings(first: 30, after: $after) { __typename edges { __typename ranking: node { __typename ...RankingWithGame } } pageInfo { __typename endCursor hasNextPage } } } }"#,
    ...
    struct Data: Api.SelectionSet {
      ...
      static var __selections: [ApolloAPI.Selection] { [
        .field("shelf", Shelf.self, arguments: ["id": .variable("id")]),
      ] }

      var shelf: Shelf { __data["shelf"] }
        ...
        struct Rankings: Api.SelectionSet {
          ...
          struct Edge: Api.SelectionSet {
            ...
            struct Ranking: Api.SelectionSet {
              ...
              /// Shelf.Rankings.Edge.Ranking.Game
              ///
              /// Parent Type: `Game`
              ...
              /// Shelf.Rankings.Edge.Ranking.Shelf
              ///
              /// Parent Type: `Shelf`
              struct Shelf: Api.SelectionSet {
                let __data: DataDict
