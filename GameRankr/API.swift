...
public final class CommentMutation: GraphQLMutation {
  ...
  public static var requestString: String { return operationString.appending(CommentBasic.fragmentString) }
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public struct Comment: GraphQLSelectionSet {
      ...
      public init(id: GraphQLID, comment: String, createdAt: String) {
        self.init(snapshot: ["__typename": "Comment", "id": id, "comment": comment, "created_at": createdAt])
      }
...
public final class GameQuery: GraphQLQuery {
  ...
  public static var requestString: String { return operationString.appending(GameBasic.fragmentString).appending(RankingForGame.fragmentString).appending(UserBasic.fragmentString) }
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public struct Game: GraphQLSelectionSet {
      ...
      public init(id: GraphQLID, title: String, ports: [Port], rankings: Ranking) {
        self.init(snapshot: ["__typename": "Game", "id": id, "title": title, "ports": ports.map { $0.snapshot }, "rankings": rankings.snapshot])
      }
        ...
        public struct Edge: GraphQLSelectionSet {
          ...
          public struct Node: GraphQLSelectionSet {
            ...
            public struct Fragments {
              ...
              public var rankingForGame: RankingForGame {
                get {
                  return RankingForGame(snapshot: snapshot)
                }
                set {
                  snapshot += newValue.snapshot
                }
...
public final class GameRankingsQuery: GraphQLQuery {
  ...
  public static var requestString: String { return operationString.appending(RankingForGame.fragmentString).appending(UserBasic.fragmentString) }
...
public struct CommentWithUser: GraphQLFragment {
  public static let fragmentString =
...
public struct RankingForGame: GraphQLFragment {
  public static let fragmentString =
    "fragment RankingForGame on Ranking {\n  __typename\n  id\n  ranking\n  review\n  verb\n  shelves {\n    __typename\n    name\n  }\n  port {\n    __typename\n    id\n  }\n  user {\n    __typename\n    ...UserBasic\n  }\n}"
